    ...
    <section id="method" className="py-24 relative z-10">
      <div className="container mx-auto px-4">
        <div className="text-lightenter mb-16">
          ...
          <p className="text-lg text-light max-w-3xl mx-auto mt-4">
            {language === 'zh'
        ...
        <div className="organics rounded-2xl p-8 md:p-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {['About', 'Methodology', 'FAQ', 'Disclaimer', 'Privacy Policy', 'Terms'].map((item) => (
              <div key={item} className="rounded-lg border border-[rgba(160,148,136,0.25)] bg-[rgba(0,0,0,0.05)] px-4 py-3 text-light text-sm">
                {item}
              </div>
            ))}
          </div>
