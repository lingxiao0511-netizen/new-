    ...
    return (
      <section className="py-20 oriental-gradient">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto oriental-card text-lightenter">
            <div className="mb-8">
            ...
            <h3 className="text-mutedxl font-serif font-bold text-primary mb-4">{language === 'zh' ? '测算请求已提交' : 'Reading Request Submitted'}</h3>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a 
                href="#services" 
                className="bg-primary hover:bg-secondary text-primary font-medium py-2 px-6 rounded-lg transition-colors"
              >
                {language === 'zh' ? '浏览更多服务' : 'Browse More Services'}
              </a>
              <a 
                href="#contact" 
                className="border border-primary text-primary hover:bg-primary hover:text-primary font-medium py-2 px-6 rounded-lg transition-colors"
              >
    ...
    <section className="py-20 oriental-gradient">
      <div className="container mx-auto px-4">
        <div className="text-lightenter mb-16">
          ...
          <h2 className="text-3xl md:text-primaryxl font-serif font-bold text-primary mb-4">{language === 'zh' ? '免费八字测算' : 'Free Birth Chart Reading'}</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="oriental-card p-8">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full bg-secondary hover:bg-secondary/90 text-primary font-medium py-3 px-6 rounded-lg transition-colors flex items-center justify-center"
                >
                  {isSubmitting ? (
                    <>
            ...
            <div>
              <div className="oriental-border rounded-xl overflow-hidden mb-8">
                <img 
                  src="https://images.pexels.com/photos/3569284/pexels-photo-3569284.jpeg?auto=format&fit=crop&q=80&w=600&h=400" 
