        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            {navItems.map((item) => (
              <Link
                key={item.href}
                href={item.href}
                className="text-[var\(--light-text\)\] hover:text-white transition-colors text-sm relative group"
              >
                {item.label}
            ...
            <button
              ...
              className="flex items-center gap-1 text-[var\(--light-text\)\] hover:text-white text-sm border border-gray-700 rounded-full px-3 py-1 transition-all"
            >
            ...
            <Link
              href="/tools"
              className="bg-gradient-to-r from-[#5ba4a4] to-[#c2704e] text-black px-5 py-2 rounded text-sm font-bold hover:from-[#c2704e] hover:to-[#5ba4a4] transition-all transform hover:scale-105 shadow-[0_0_15px_rgba(125,211,252,0.3)]"
            >
          ...
          <div className="-mr-2 flex md:hidden">
            <button
              ...
              className="text-[var\(--light-text\)\] hover:text-white"
            >
          ...
          <div className="px-4 pt-4 pb-6 space-y-3">
            {navItems.map((item) => (
              <Link
                key={item.href}
                href={item.href}
                className="block text-[var\(--light-text\)\] hover:text-white py-2"
