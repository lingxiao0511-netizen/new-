      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto">
          <div className="glass-card rounded-2xl p-8 md:p-12 relative overflow-hidden">
            <div className="text-[#7dd3fc] opacity-10 absolute -right-8 -bottom-8 text-[150px] font-serif">
              {language === 'zh' ? '运' : '🔮'}
            </div>
            
            <div className="flex items-center justify-center mb-6">
              <div className="w-20 h-20 bg-gradient-to-r from-[#7dd3fc]/20 to-[#a78bfa]/20 rounded-full flex items-center justify-center breathing border border-[#7dd3fc]/30">
