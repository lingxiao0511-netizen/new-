    ...
    <main className="min-h-screen bg-gradient-to-br from-[#faf6f0] via-[#f5f0e8] to-[#ece3d5] text-[#231a14] pt-32 pb-20">
      <div className="max-w-5xl mx-auto px-4">
        <div className="max-w-3xl mb-14">
          <p className="text-[#5ba4a4] uppercase tracking-[0.3em] text-xs">Our Approach</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
          {values.map((item) => (
            <div key={item.title} className="organics rounded-2xl p-8">
              <h2 className="text-2xl font-serif font-bold">{item.title}</h2>
              <p className="text-[#7a6d60] mt-4 leading-relaxed">{item.body}</p>
            </div>
          ))}
        </div>
