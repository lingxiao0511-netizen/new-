  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#faf6f0] via-[#f5f0e8] to-[#ece3d5] text-[#231a14] pt-32 pb-20">
      <article className="max-w-4xl mx-auto px-4">
        ...
        <p className="text-[#7a6d60] text-lg mt-6 leading-relaxed">AI can be helpful in a modern metaphysics product, but users should understand where it helps and where it should be constrained. This page explains that clearly.</p>
        ...
        <div className="organics rounded-2xl p-8 md:p-10 mt-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-[#504035]">
            ...
            <Link href="/learn/can-ai-read-bazi" className="rounded-xl border border-[rgba(160,148,136,0.3)] bg-[rgba(255,253,248,0.9)] p-4">Read: Can AI read BaZi?</Link>
            <Link href="/tools" className="rounded-xl border border-[rgba(160,148,136,0.3)] bg-[rgba(255,253,248,0.9)] p-4">Go to tools</Link>
          </div>
        </div>
      </article>
    </main>
