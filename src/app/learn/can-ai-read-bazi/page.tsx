  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#faf6f0] via-[#f5f0e8] to-[#ece3d5] text-[#231a14] pt-32 pb-20">
      <article className="max-w-4xl mx-auto px-4">
        <p className="text-[#5ba4a4] uppercase tracking-[0.3em] text-xs">Trust & Clarity</p>
        ...
        <div className="organics rounded-2xl p-8 md:p-10 mt-10 space-y-6 text-[#504035] leading-relaxed">
          <h2 className="text-3xl font-serif font-bold text-[#231a14]">What AI is good at</h2>
          <p>
          ...
          <h2 className="text-3xl font-serif font-bold text-[#231a14]">What AI is not good at on its own</h2>
          <p>
          ...
          <h2 className="text-3xl font-serif font-bold text-[#231a14]">A more reliable way to do it</h2>
          <p>
          ...
          <h2 className="text-3xl font-serif font-bold text-[#231a14]">Where human judgment still matters</h2>
          <p>
          ...
          <h2 className="text-3xl font-serif font-bold text-[#231a14]">Why transparency matters</h2>
          <p>
        ...
        <div className="organics rounded-2xl p-8 md:p-10 mt-10">
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-[#504035]">
            <Link href="/learn/how-we-use-ai" className="rounded-xl border border-[rgba(160,148,136,0.3)] bg-[rgba(255,253,248,0.9)] p-4 hover:border-[#5ba4a4]/30 transition-colors">Read next: How we use AI</Link>
