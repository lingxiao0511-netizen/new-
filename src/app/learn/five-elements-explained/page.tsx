    ...
    <main className="min-h-screen bg-gradient-to-br from-[#1a1a2e] via-[#16213e] to-[#0f3460] text-white pt-32 pb-20">
      <article className="max-w-4xl mx-auto px-4">
        ...
        <div className="glass-card rounded-2xl p-8 md:p-10 mt-10 space-y-6 text-gray-300 leading-relaxed">
          ...
          <h2 className="text-3xl font-serif font-bold text-white pt-4">The generative cycle</h2>
          <p>
          ...
          <h2 className="text-3xl font-serif font-bold text-white pt-4">The controlling cycle</h2>
          <p>
          ...
          <h2 className="text-3xl font-serif font-bold text-white pt-4">Why this matters in BaZi</h2>
          <p>
          ...
          <h2 className="text-3xl font-serif font-bold text-white pt-4">Why oversimplification causes problems</h2>
          <p>
          ...
          <h2 className="text-3xl font-serif font-bold text-white pt-4">A more useful beginner mindset</h2>
          <p>
