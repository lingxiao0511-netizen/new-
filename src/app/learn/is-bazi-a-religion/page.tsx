  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#faf6f0] via-[#f5f0e8] to-[#ece3d5] text-[#231a14] pt-32 pb-20">
      <article className="max-w-4xl mx-auto px-4">
        ...
        <p className="text-[#7a6d60] text-lg mt-6 leading-relaxed">Many international readers ask this because they want cultural context before engaging with the subject. In most modern usage, BaZi is better understood as a traditional metaphysical and interpretive system rather than an organized religion.</p>
        ...
        <div className="organics rounded-2xl p-8 md:p-10 mt-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-[#504035]">
            ...
            <Link href="/learn/what-is-bazi" className="rounded-xl border border-[rgba(160,148,136,0.3)] bg-[rgba(255,253,248,0.9)] p-4">Read: What is BaZi?</Link>
