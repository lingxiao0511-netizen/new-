  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#faf6f0] via-[#f5f0e8] to-[#ece3d5] text-[#231a14] pt-32 pb-20">
      <article className="max-w-4xl mx-auto px-4">
        <p className="text-[#5ba4a4] uppercase tracking-[0.3em] text-xs">Career</p>
        <h1 className="text-5xl font-serif font-bold mt-4">Can BaZi Predict Career?</h1>
        <p className="text-[#7a6d60] text-lg mt-6 leading-relaxed">Career is another major reason people seek out BaZi. In practice, BaZi is often used less as a literal job-title predictor and more as a framework for understanding tendencies, strengths, pressure patterns, resources, timing shifts, and directional fit.</p>
        ...
        <div className="organics rounded-2xl p-8 md:p-10 mt-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-[#504035]">
            <Link href="/reports" className="rounded-xl border border-[rgba(160,148,136,0.3)] bg-[rgba(255,253,248,0.9)] p-4">Explore deeper reports</Link>
            <Link href="/learn/what-is-a-day-master" className="rounded-xl border border-[rgba(160,148,136,0.3)] bg-[rgba(255,253,248,0.9)] p-4">Read: What is a Day Master?</Link>
            <Link href="/tools" className="rounded-xl border border-[rgba(160,148,136,0.3)] bg-[rgba(255,253,248,0.9)] p-4">Try free tools</Link>
          </div>
        </div>
      </article>
    </main>
