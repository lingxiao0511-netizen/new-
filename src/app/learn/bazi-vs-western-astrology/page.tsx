  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#1a1a2e] via-[#16213e] to-[#0f3460] text-white pt-32 pb-20">
      <article className="max-w-4xl mx-auto px-4">
        <p className="text-[#7dd3fc] uppercase tracking-[0.3em] text-xs">Comparison</p>
        ...
        <div className="glass-card rounded-2xl p-8 md:p-10 mt-10 space-y-6 text-gray-300 leading-relaxed">
          <h2 className="text-3xl font-serif font-bold text-white">Different chart logic</h2>
          <p>
          ...
          <h2 className="text-3xl font-serif font-bold text-white">Different emotional feel</h2>
          <p>
          ...
          <h2 className="text-3xl font-serif font-bold text-white">Different use of time</h2>
          <p>
          ...
          <h2 className="text-3xl font-serif font-bold text-white">What they have in common</h2>
          <p>
          ...
          <h2 className="text-3xl font-serif font-bold text-white">Which is better?</h2>
          <p>
